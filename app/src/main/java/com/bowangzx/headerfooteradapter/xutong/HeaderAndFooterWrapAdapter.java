package com.bowangzx.headerfooteradapter.xutong;
...
public abstract class HeaderAndFooterWrapAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    protected class ViewAndData {
        ...
        public ViewAndData(int layoutId, Object data, int cacheSize) {
            this.layoutId = layoutId;
            this.data = data;
            this.cacheSize = cacheSize;
        }

        public ViewAndData(int layoutId, Object data) {
            this.layoutId = layoutId;
            this.data = data;
    ...
    protected ArrayList<ViewAndData> mHeaderDatas = new ArrayList<>();

    protected ArrayList<ViewAndData> mFooterDatas = new ArrayList<>();

    protected RecyclerView.Adapter mInnerAdapter;//内部的的普通Adapter

    public HeaderAndFooterWrapAdapter(RecyclerView.Adapter mInnerAdapter) {
    ...
    public void addHeaderView(int layoutId, Object data) {
        ...
        mHeaderDatas.add(new ViewAndData(layoutId, data));
    }
    ...
    public void addHeaderView(int layoutId, Object data, int cacheSize) {
        ...
        mHeaderDatas.add(new ViewAndData(layoutId, data, cacheSize));
    }
     ...
     * @param data
     */
    public void addFooterView(ViewAndData data) {
    ...
    public void setFooterView(ViewAndData data) {
        clearFooterView();
        addFooterView(data);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (mHeaderDatas != null && !mHeaderDatas.isEmpty()) {//不为空，说明有headerview
            for (ViewAndData headerData : mHeaderDatas) {
    ...
    private boolean isFooterView(int viewType) {
        ...
        for (ViewAndData footerData : mFooterDatas) {
